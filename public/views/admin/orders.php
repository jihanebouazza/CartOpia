        ...
        <tbody>
          <?php foreach ($orders as $order) : ?>
            <tr>
              ...
              <td>
                <a target="_blank" href="<?= ROOT ?>/views/user/pdf.php?id=<?= $order['order_id'] ?>" class="icon-button" style="color: #A19796; border-color: #A19796;padding: 4px 4px 4px 6px;">
                  <i style="color: #A19796;" class="fa-solid fa-print fa-sm"></i>
                </a>
                <a href="<?= ROOT ?>/views/admin/order_edit.php?id=<?= $order['order_id'] ?>" style="margin: 0px 4px; color: #A19796; border-color: #A19796;padding: 4px 4px 4px 6px;" href="<?= ROOT ?>/views/products/cart.php" class="icon-button">
